import {
  ...
  const ReviewAvatar = ({ src, name, country }) => {
    return (
      ...
      <Box bg={useColorModeValue("gray.100", "gray.700")} id="reviews">
        <Container maxW={"7xl"} py={36} as={Stack} spacing={70}>
          ...
          >
            <Review>
              <ReviewContent>
                <ReviewHeading>Efficient App</ReviewHeading>
                <TestimonialText>
            ...
            <Review>
              <ReviewContent>
                <ReviewHeading>Intuitive Design</ReviewHeading>
                <TestimonialText>
            ...
            <Review>
              <ReviewContent>
                <ReviewHeading>Mindblowing Service</ReviewHeading>
                <TestimonialText>
